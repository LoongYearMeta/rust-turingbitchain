...
use util::length_tracking_writer::LengthTrackingWriter;
...
impl BlockHeader {
    ...
    pub fn block_hash(&self) -> BlockHash {
        ...
        let mut length_tracking_enc = LengthTrackingWriter::new(&mut engine);
        self.consensus_encode(&mut length_tracking_enc).expect("engines don't error");
